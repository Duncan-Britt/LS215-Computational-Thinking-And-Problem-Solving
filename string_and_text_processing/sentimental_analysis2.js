...
function sentiment(text) {
  pCaptures = text.match(positiveRegex).map(word => word.toLowerCase());
  nCaptures = text.match(negativeRegex).map(word => word.toLowerCase());
  const nPos = pCaptures.length;
  const nNeg = nCaptures.length;
  ...
  console.log(`There are ${nPos} positive words in the text.`);
  console.log(`Positive sentiments: ${pCaptures.join(', ')}\n`);
  console.log(`There are ${nNeg} negative words in the text.`);
  console.log(`Negative sentiments: ${nCaptures.join(', ')}\n`);
